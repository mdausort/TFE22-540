...
def CC_division(folder_path, patient_path):
    ...
    for time in list_time:
        ...
        CC_path = patients_path + "#" + name + "/Atlas/CC/Corpus_callosum_hand_drawn_morpho_reg_on_sub" + name + "_" + time + ".nii.gz"
        ...
        out1.to_filename(patients_path + "#" + name + "/Atlas/CC/Corpus_callosum_genu_reg_on_sub" + name + "_" + time + ".nii.gz")
        
        out2 = nib.Nifti1Image(corpus_callosum_anterior_midbody, corpus_callosum_load.affine, header = corpus_callosum_load.header)
        out2.to_filename(patients_path + "#" + name + "/Atlas/CC/Corpus_callosum_anterior_midbody_reg_on_sub" + name + "_" + time + ".nii.gz")
        
        out3 = nib.Nifti1Image(corpus_callosum_isthmus, corpus_callosum_load.affine, header = corpus_callosum_load.header)
        out3.to_filename(patients_path + "#" + name + "/Atlas/CC/Corpus_callosum_isthmus_reg_on_sub" + name + "_" + time + ".nii.gz")
        
        out4 = nib.Nifti1Image(corpus_callosum_posterior_midbody, corpus_callosum_load.affine, header = corpus_callosum_load.header)
        out4.to_filename(patients_path + "#" + name + "/Atlas/CC/Corpus_callosum_posterior_midbody_reg_on_sub" + name + "_" + time + ".nii.gz")
        
        out5 = nib.Nifti1Image(corpus_callosum_splenium, corpus_callosum_load.affine, header = corpus_callosum_load.header)
        out5.to_filename(patients_path + "#" + name + "/Atlas/CC/Corpus_callosum_splenium_reg_on_sub" + name + "_" + time + ".nii.gz")
